...
class MultiParaRCReader(DatasetReader):
    ...
    def read_examples(self, file):
        is_crossentityqa = "crossentityqa" in file.lower() or "CrossEntityQA" in file
        with open(file, "r") as input_fp:
            for line in tqdm(input_fp):
                ...
                if is_crossentityqa:
                    ...
                    formatted_answers = [tuple(format_drop_answer(answers_object)) for answers_object in answers_objects]
